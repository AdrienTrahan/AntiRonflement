...
class PageViewController: UIPageViewController, UIPageViewControllerDelegate, UIPageViewControllerDataSource {
    ...
    lazy var orderedViewControllers: [UIViewController] = {
        return [self.newVc(viewController: "screen1"),
                ...
                self.newVc(viewController: "screen5")]
    }()
    ...
    func configurePageControl() {
        ...
        var button = UIButton(frame: CGRect(x: 0, y: 40, width: 200, height: 50))
        button.center.x = 35
        button.center.y = 60
        ...
        self.pageControl.tintColor = UIColor.white.withAlphaComponent(0.5)
        self.pageControl.pageIndicatorTintColor = UIColor.white
        self.pageControl.currentPageIndicatorTintColor = UIColor.white.withAlphaComponent(0.5)
